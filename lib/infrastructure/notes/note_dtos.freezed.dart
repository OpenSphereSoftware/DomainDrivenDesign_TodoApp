...
mixin _$NoteDto {
  ...
  List<TodoItemDto> get todos =>
      throw _privateConstructorUsedError; // placeholder -> time on server when the note has been updated
...
class _$_NoteDto extends _NoteDto {
  ...
  @override // placeholder -> time on server when the note has been updated

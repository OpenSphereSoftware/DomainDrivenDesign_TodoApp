...
class _$NoteFormEventTearOff {
  ...
  _TodosChanged todosChanged(KtList<TodoItemPremitive> todos) {
  ...
  _Initialized initialized(Note? initialNoteOption) {
    return _Initialized(
      initialNoteOption,
    );
  }
...
abstract class _TodosChanged implements NoteFormEvent {
  const factory _TodosChanged(KtList<TodoItemPremitive> todos) =
      _$_TodosChanged;
...
abstract class _Initialized implements NoteFormEvent {
  const factory _Initialized(Note? initialNoteOption) = _$_Initialized;
